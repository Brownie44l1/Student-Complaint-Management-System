            ...
            <div class="main-content">
                ...
                <div class="content">
                    ...
                    $query = "SELECT id AS complaint_no, fullname AS complainant_name, reg_date, status 
                            FROM complaints 
                            WHERE status = 'not processed' AND forwarded_to IS NULL";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><button style='background-color: #fa0000ec; color: #fff; border: none; padding: 5px 6px; border-radius:5px;'>" . $row['status'] . "</button></td>";
