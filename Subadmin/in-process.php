        ...
        <div class="main-container">
            ...
            <div class="content">
                ...
                if ($subadmin_stmt) {
                    ...
                    // Fetch complaints with status 'in process' forwarded to the logged-in subadmin
                    $query = "SELECT id AS complaint_no, fullname AS complainant_name, reg_date, status 
                            FROM complaints 
                            WHERE status = 'in process' AND forwarded_to = ?";
                    ...
                    if ($stmt) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><button style='background-color: yellow; color: #000; border: none; padding: 5px 6px; border-radius:5px;'>" . $row['status'] . "</button></td>";
